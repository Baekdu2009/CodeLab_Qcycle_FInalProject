...
public class MxCom : MonoBehaviour
{
    [SerializeField] private EachFilamentFactory filamentFactory;
    public enum Status
    {
        CONNECTED,
        DISCONNECTED
    ...
    private void Start()
    {
        ...
        {
            filamentFactory = FindObjectOfType<EachFilamentFactory>(); // 씬에서 찾아서 할당
        }
